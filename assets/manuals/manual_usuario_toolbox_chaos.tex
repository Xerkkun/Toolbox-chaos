...
\vspace{0.55cm}
{\large Fyskode Chaotic Systems Toolbox 0.1.0\par}
\vspace{0.8cm}
...
\begin{enumerate}
  ...
  \item Descargue \archivo{chaos-toolbox-v0.1.0-windows-x64-setup.exe}.
...
\input{chapters/manual_usuario_recetario_ampliado}
...
La referencia del software es: Maria Fernanda Moreno Lopez (Fer Moreno), \emph{Fyskode Chaotic Systems Toolbox}, versión 0.1.0, licencia MIT. Repositorio: \urlimpresa{https://github.com/Xerkkun/Toolbox-chaos}. DOI: \urlimpresa{https://doi.org/10.17605/OSF.IO/GQMJR}.
