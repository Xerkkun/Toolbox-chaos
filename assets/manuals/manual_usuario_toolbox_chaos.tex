...
La referencia candidata del software es: Maria Fernanda Moreno Lopez (Fer Moreno), \emph{Fyskode Chaotic Systems Toolbox}, versión 0.2.0, licencia MIT. Esta versión todavía no está publicada ni tiene un DOI específico nuevo. Repositorio: \urlimpresa{https://github.com/Xerkkun/Toolbox-chaos}. DOI vigente del proyecto/archivo: \urlimpresa{https://doi.org/10.17605/OSF.IO/GQMJR}.
