...
\dot{x}=F(x).
\]
La toolbox puede integrar estos sistemas con Euler, Heun o RK4. Euler es útil para reproducir
el espíritu de programas históricos; Heun y RK4 ofrecen mayor orden local para campos suaves,
pero ningún esquema garantiza estabilidad sin comprobar la convergencia al reducir \(h\):
\[
