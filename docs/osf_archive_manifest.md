...
- generated installers and previous package artifacts
...
- private or non-redistributable resources, including original Sprott book disk files and user-local `.DIC` files
- large PDFs not required by the UI or paper review
