...
> [!WARNING]
> La estimación rápida de Lyapunov es una herramienta heurística de cribado. Un exponente rápido positivo no constituye una demostración formal de caos matemático. Para fortalecer la evidencia se requiere un análisis dinámico más amplio, con espectro de Lyapunov, refinamiento del paso y horizonte, sensibilidad a condiciones iniciales y secciones de Poincaré cuando sean aplicables.
